...
function mousePressed() {
  ...
  if(activeScene.id == "selectDrummer") {
    if((mouseX > activeScene.c2pos - 125 && mouseX < activeScene.c2pos + 125) && (mouseY > activeScene.row*6 - 30 && mouseY < activeScene.row*6 + 30)) {
      console.log("Ringo Starr Selected");
      ringoSelected = true;
      sceneTransition = true;
    } else if((mouseX > activeScene.c1pos - 125 && mouseX < activeScene.c1pos + 125) && (mouseY > activeScene.row*6 - 30 && mouseY < activeScene.row*6 + 30)) {
      console.log("Danny Kerry Selected");
      dannySelected = true;
      sceneTransition = true;
    } else if((mouseX > activeScene.c3pos - 125 && mouseX < activeScene.c3pos + 125) && (mouseY > activeScene.row*6 - 30 && mouseY < activeScene.row*6 + 30)) {
